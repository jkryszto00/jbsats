                                ...
                                <div class="flex justify-center">
                                    <div class="w-1/3 flex flex-col">
                                        ...
                                        <DialogDescription class="mb-8 p-2 bg-neutral-50 border border-neutral-300 rounded-lg">
                                            <div class="flex items-center gap-2">
                                                <img :src="jobOffer.company.logo" :alt="jobOffer.company.name" class="h-10 w-10 border border-neutral-200 rounded object-cover">
                                                <div>
                                                    <div class="font-medium text-neutral-700 transition-all hover:text-neutral-900">{{ jobOffer.title }}</div>
                                                    <div class="block text-sm text-neutral-500">{{ jobOffer.company.name }}</div>
                                                </div>
                                            </div>
                                        </DialogDescription>
