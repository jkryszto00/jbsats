...
const form = useForm({
    title: prop.model.job_offer.title,
    description: prop.model.job_offer.description,
    category: prop.model.job_offer.categories,
    level: prop.model.job_offer.level.value,
    contract: {
        currency: prop.model.job_offer.contract.currency,
        time: prop.model.job_offer.contract.time
    },
    salary: prop.model.job_offer.salaries
})

const submit = () => {
    form.patch(route('panel.posting.update', { jobOffer: prop.model.job_offer }))
}
</script>
<template>
    <PanelLayout>
